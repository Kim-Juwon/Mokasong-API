...
public enum CustomExceptionList {
    ...
    TOKEN_CREATION_HAS_PROBLEM(108, "토큰 발급 과정에서 에러가 발생하였습니다.", HttpStatus.INTERNAL_SERVER_ERROR),

    TOKEN_DIRTY_DETECTED(109, "토큰 변경이 감지되었습니다.", HttpStatus.UNAUTHORIZED),

    TOKEN_NOT_EXIST_IN_REQUEST(110, "요청 헤더에 토큰이 없습니다.", HttpStatus.UNAUTHORIZED),

    TOKEN_NOT_CONTAIN_BEARER(111, "토큰은 Bearer +token 형태로 전송해야합니다.", HttpStatus.UNAUTHORIZED),
